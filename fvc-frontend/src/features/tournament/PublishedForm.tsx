      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-b-xl shadow-md border border-[#dadce0]">
          ...
          <div className="p-6 pb-4 border-b border-[#dadce0]">
            ...
            {expired && (
              <div className="mt-4 flex items-center gap-3 p-4 bg-orange-50 border border-orange-200 rounded-lg">
          ...
          <form onSubmit={handleSubmit}>
            <div className="p-6 space-y-6">
              ...
              {participantsPerEntry && participantsPerEntry > 1 && (
                <div className="rounded-xl border border-[#dadce0] p-5 space-y-4">
            ...
            <div className="px-6 py-5 border-t border-[#dadce0] bg-[#f8f9fa] rounded-b-xl">
              <div className="flex items-center justify-end">
                <button
                  ...
                  className={`font-medium rounded px-6 py-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                    expired
                      ? "bg-gray-300 text-gray-600"
                      : "bg-[#1a73e8] hover:bg-[#1669c1] text-white"
                  }`}
                >
                  {submitting ? "Đang gửi..." : expired ? "Đã hết hạn" : "Gửi"}
                </button>
              </div>
            </div>
          </form>
